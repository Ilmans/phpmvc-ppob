...
class Riwayat extends Controller
{
    ...
    public function index()
    {
        ...
        $data['riwayatpembelianpascabayar'] = $this->model('Riwayat_model')->riwayatpembelianpascabayar($username);
    ...
    public function detailpesananpascabayar()
    {
        $id_pemesanan = $_POST['idpesanan'];
        $this->dbh->query("SELECT * FROM pembelian_pascabayar WHERE oid = '$id_pemesanan' ");
        $this->dbh->execute();
