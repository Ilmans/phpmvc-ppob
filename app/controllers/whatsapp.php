...
*Total Belanja : " . $belanja . "X*
*Total Pemakaian Saldo : " . $pemakaiansaldo . "*
*-------------------*
*Terima Kasih telah menjadi bagian*
*dari " . WEB_NAME . ".*
*-------------------*
*Untuk transaksi yang lebih lengkap*
*seperti token listrik, paket internet,*
*paket telpon, topup emoney - dana,ovo,*
*gojek,linkaja - follower sosial media,*
*bpjs, pln dan internet pascabayar,*
*telpon pascabayar, voucher game,* 
*atau TOKO ONLINE, silahkan login*
*app atau kunjungi website:*
*-------------------*
*" . BASEURL . "*
";
        } else {
            return 'Nomor anda belum terdaftar di *Solusi Media*, Silahkan daftar terlebih dahulu disini https://solusimedia.com/public/auth/register';
        }
    }
            ...
            if ($datauser['saldo_top_up'] < $layanannya['harga']) {
                ...
                if ($provider == "DG-PULSA" && $statusasal == "Gagal") {
                    ...
                    if ($this->model('Order_model')->insertorderppob($order_id, $provider_oid, $namalayanan, $harga, $target, $provider, 'WA', $username, $statusnya) > 0) {
                        ...
                        return
                            '
*Terimakasih, Pesanan Kamu Telah Kami Terima.*
*ID order : ' . $order_id . '*
*Layanan : ' . $namalayanan . '*
*Harga : ' . $jumlah2 . '*
*Tujuan : ' . $target . '*

Untuk melihat status dan
detail pesanan gunakan keyword *STATUS.IDORDER*';
            ...
            return 'Nomor Anda tidak terdaftar di ' . WEB_NAME . '. Silahkan daftar terlebih dahulu disini https://solusimedia.com/public/auth/register';
        }
    }
