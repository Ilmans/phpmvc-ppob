        ...
        <div class="row invoice">
            <div class="col-lg-12 card mt-4">
                <div class="invoice-contents" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="background-color:#ffffff; height:auto; max-width:830px; font-family: Helvetica,Arial,sans-serif !important; position: relative;">
                    <table class="" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" style="width:100%; background-color:#ffffff;border-collapse:separate !important; border-spacing:0;color:#242128; margin:0;padding:10px;" heigth="auto">
                            ...
                            <tr>
                                ...
                                <td align="right" valign="center" style="padding-bottom:35px; padding-top:15px; border-top:0;width:100% !important;">
                                    <p style="color: #8f8f8f; font-weight: normal; line-height: 1.2; font-size: 12px; white-space: nowrap; ">
                                        <?= WEB_NAME; ?><br>Darma, Kabupaten Kuningan,<br>Jawa Barat<br>45562
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2" style="padding-top:30px; border-top:1px solid #f1f0f0">
                                    <table style="width: 100%;">
                                        <tbody>
                                            <tr>
                                                <td style="vertical-align:middle; border-radius: 15px; padding:10px; background-color: #f9f9f9; border-right: 5px solid white;">
                                                ...
                                                <td style="text-align: right; padding-top:0px; padding-bottom:0; vertical-align:middle; padding:10px; background-color: #f9f9f9; border-radius: 15px; border-left: 5px solid white;">
                                    ...
                                    <table style="width: 100%; margin-top:40px;">
                                        <thead>
                                            <tr>
                                                <th style="padding-right: 10px;font-size: 12px; color:#8f8f8f; padding-bottom: 0px;">
                                                    Pembayaran melalui
                                                </th>
                                                <th style="padding-right: 10px;font-size: 12px; color:#8f8f8f; padding-bottom: 0px;">
                                                    Jumlah Transfer
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="2" style="width: 100%">
                                <p href="#" style="font-weight: bold;font-size: 13px; text-decoration: none; line-height: 1.6; color:#909090; margin-top:0px; margin-bottom:0; text-align: right;">
                ...
                <div class="tombol mt-10 mb-20" style="padding: 20px;">
                    ...
                    <?php if ($deposit['status'] == 'Pending') : ?>
                        ...
                        <a class="btn btn-success" href="<?= BASEURL; ?>deposit/konfirmasideposit/<?= $deposit['kode_deposit']; ?>/<?= $deposit['jumlah_transfer']; ?>">Konfirmasi</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
