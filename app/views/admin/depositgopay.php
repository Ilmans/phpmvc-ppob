...
if (isset($_POST['cek'])) {
    ...
    //$acc = $gopay->getTransactionHistory();
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-4">
            <div class="col-12 mb-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="data-table data-table-feature table-responsive col-12 w-100 d-block d-md-table">
                            <thead>
                                <tr>
                                    <th>Tanggal & waktu</th>
