                                ...
                                <?php foreach ($data['allcategory'] as $data_kategori) : ?>
                                    ...
                                    <tr>
                                        <form action="<?= BASEURL; ?>admin/otheractioncategory" class="form-inline" role="form" method="POST">
                                            ...
                                            <td><input type="text" class="form-control" style="width: 200px;" name="nama" value="<?php echo $data_kategori['brand']; ?>"></td>
                                            <td style="display: none;"><?= $data_kategori['brand']; ?></td>
                                            <td><input type="text" class="form-control" style="width: 200px;" name="kode" value="<?php echo $data_kategori['brand']; ?>"></td>
                                            <td>
