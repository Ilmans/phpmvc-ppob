                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control" name="kategori">
                                    ...
                                    <?php
                                    $cek_kategori = $dbh->prepare("SELECT * FROM kategori_layanan WHERE server = 'Sosial Media' ORDER BY brand ASC");
                                    $cek_kategori->execute(); ?>

                                    <?php foreach ($cek_kategori->fetchAll(PDO::FETCH_ASSOC) as $data_kategori) {
                                    ?>
                                        <option value="<?php echo $data_kategori['brand']; ?>"><?php echo $data_kategori['brand']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
