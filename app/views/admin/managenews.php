                            ...
                            <tbody>
                                <?php foreach ($data['allnews'] as $news) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="javascript:;" onclick="users('<?= BASEURL; ?>admin/editnews/<?= $news['id']; ?>')" class="btn  btn-warning"><i class="simple-icon-note" title="Ubah"></i></a>
                                            <a href="<?= BASEURL; ?>admin/deletenews/<?= $news['id']; ?>" class="btn  btn-danger "><i class="simple-icon-trash" title="Hapus"></i></a>
                                        </td>
