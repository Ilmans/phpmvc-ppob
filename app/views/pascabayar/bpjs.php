                ...
                <div class="card p-4 col-12">
                    <div class="card-body d-flex border__bottom-dash">
                        <div class="text-center">
                            <img src="<?= BASEURL; ?>icon/bpjs.png" alt="balance-icon" width="100px" height="100px" style="margin-left:50px ;">
                        </div>
    ...
    <script>
        function cektagihan() {
            ...
            if (nopelanggan.length == 0 || pin.length == 0) {
                ...
                $.ajax({
                    url: url.concat('pascabayar/cektagihanbpjs'),
                    type: 'post',
                    dataType: 'html',
                    data: {
