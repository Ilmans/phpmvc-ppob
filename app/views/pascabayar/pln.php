                ...
                <div class="card p-4 col-12">
                    ...
                    <form method="POST" id="formpln">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="skucode" id="skucode" required>
                                <option value="" selected disabled>Pilih Metode</option>
                                <?php foreach ($data['pln'] as $d) : ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pin" type="pin" class="form-control" placeholder="" aria-label="" id="pin" required>

                        </div>
                        <div class="text-center mt-5 mb-3">
                            <button type="submit" name="submitpln" id="submitpln" class="btn btn-info shadow pl-4 pr-4 ">
                                Cek tagihan
                            </button>
                        </div>
                    </form>
    ...
    $(document).ready(function() {
        ...
        $('#formpln').validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: url.concat('pascabayar/cektagihanpln'),
                    type: 'post',
                    data: $(form).serialize(),
                    beforeSend: function() {
