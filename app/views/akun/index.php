                        ...
                        <div class="row">
                            <div class="col-12 col-lg-5 col-xl-4 col-left">
                                <div class="card mb-4">
                                    ...
                                    <img src="img/profiles/profile.png" alt="Detail Picture" class="card-img-top" />
                                    <?php $user = $data['user']; ?>
                                    <div class="card-body">
                                        <h2><?= $user['nama_depan']; ?> <?= $user['nama_belakang']; ?>(<?= $user['username']; ?>)</h2>
                            ...
                            <div class="card-body">
                                ...
                                <form class="col-12">
                                    ...
                                    <div class="form-group formsandibaru">
                                        <label for="sandibaru">Pin baru</label>
